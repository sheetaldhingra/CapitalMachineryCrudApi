const Product = require("../models/forte");
const connectDB = require("../db/connect");
const ProductJson = require("../products.json");

const getAllForteProducts = async (req, res) => {
...
const getAllForteProductsTesting = async (req, res) => {
  const myData =
    sort !== ""
...
const saveForteProducts = async (req, res) => {
...
const updateForteProduct = async (req, res) => {
  try {
    await connectDB();
    // await Product.create(req.body);
...
const deactivateForteProduct = async (req, res) =>{
    try {
        await connectDB();
        // await Product.create(req.body);
        await Product.updateOne(
...
const activateForteProduct = async (req, res) =>{
    try {
        await connectDB();
        // await Product.create(req.body);
        await Product.updateOne(
