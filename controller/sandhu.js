const Product = require("../models/sandhu");
const connectDB = require("../db/connect");
const ProductJson = require("../products.json");

const getAllSandhuProducts = async (req, res) => {
...
const getAllSandhuProductsTesting = async (req, res) => {
  const myData =
    sort != ""
...
const saveSandhuProducts = async (req, res) => {
...
const updateSandhuProduct = async (req, res) => {
  try {
    await connectDB();
    // await Product.create(req.body);
...
const deactivateSandhuProduct = async (req, res) =>{
    try {
        await connectDB();
        // await Product.create(req.body);
        await Product.updateOne(
...
const activateSandhuProduct = async (req, res) =>{
    try {
        await connectDB();
        // await Product.create(req.body);
        await Product.updateOne(
