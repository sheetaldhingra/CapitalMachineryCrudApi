const Product = require("../models/star");
const connectDB = require("../db/connect");
const ProductJson = require("../products.json");

const getAllStarProducts = async (req, res) => {
...
const getAllStarProductsTesting = async (req, res) => {
  const myData =
    sort !== ""
...
const saveStarProducts = async (req, res) => {
...
const updateStarProduct = async (req, res) => {
  try {
    await connectDB();
    // await Product.create(req.body);
...
const deactivateStarProduct = async (req, res) =>{
    try {
        await connectDB();
        // await Product.create(req.body);
        await Product.updateOne(
...
const activateStarProduct = async (req, res) =>{
    try {
        await connectDB();
        // await Product.create(req.body);
        await Product.updateOne(
