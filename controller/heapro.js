const Product = require("../models/heapro");
const connectDB = require("../db/connect");
const ProductJson = require("../products.json");

const getAllHeaproProducts = async (req, res) => {
...
const saveHeaproProducts = async (req, res) => {
...
const updateHeaproProduct = async (req, res) => {
  try {
    await connectDB();
    // await Product.create(req.body);
...
const deactivateHeaproProduct = async (req, res) =>{
    try {
        await connectDB();
        // await Product.create(req.body);
        await Product.updateOne(
...
const activateHeaproProduct = async (req, res) =>{
    try {
        await connectDB();
        // await Product.create(req.body);
        await Product.updateOne(
