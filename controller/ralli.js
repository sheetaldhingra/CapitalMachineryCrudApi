const Product = require("../models/ralli");
const connectDB = require("../db/connect");
const ProductJson = require("../products.json");

const getAllRalliProducts = async (req, res) => {
...
const getAllRalliProductsTesting = async (req, res) => {
  const myData =
    sort != ""
...
const saveRalliProducts = async (req, res) => {
...
const updateRalliProduct = async (req, res) => {
  try {
    await connectDB();
    // await Product.create(req.body);
...
const deactivateRalliProduct = async (req, res) =>{
    try {
        await connectDB();
        // await Product.create(req.body);
        await Product.updateOne(
...
const activateRalliProduct = async (req, res) =>{
    try {
        await connectDB();
        // await Product.create(req.body);
        await Product.updateOne(
