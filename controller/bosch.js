const Product = require("../models/bosch");
const connectDB = require("../db/connect");
const ProductJson = require("../products.json");

const getAllBoschProducts = async (req, res) => {
...
const getAllBoschProductsTesting = async (req, res) => {
  const myData =
    sort != ""
...
const saveBoschProducts = async (req, res) => {
...
const updateBoschProduct = async (req, res) => {
  try {
    await connectDB();
    // await Product.create(req.body);
...
const deactivateBoschProduct = async (req, res) =>{
    try {
        await connectDB();
        // await Product.create(req.body);
        await Product.updateOne(
...
const activateBoschProduct = async (req, res) =>{
    try {
        await connectDB();
        // await Product.create(req.body);
        await Product.updateOne(
